...
const comex_suppliers = new Table(
  {
    ...
    default_port_of_origin: column.text,
...
const comex_cotizaciones = new Table(
  {
    workspace_id: column.text,
    moneda:       column.text,
    valor_ars:    column.real,
    nota:         column.text,
    created_at:   column.integer,
  },
  { indexes: { workspace: ['workspace_id'], moneda: ['moneda'] } }
)
...
const rrhh_colaboradores = new Table(
  {
    ...
    contacto_emergencia_1_vinculo: column.text,
    contacto_emergencia_2_nombre:  column.text,
    contacto_emergencia_2_celular: column.text,
    contacto_emergencia_2_vinculo: column.text,
    created_at:              column.integer,
    updated_at:              column.integer,
  },
...
const rrhh_periodos = new Table(
  {
    ...
    total_sac:                      column.real,
    pdf_sac_nombre:                 column.text,
    pdf_sac_drive_file_id:          column.text,
    created_at:                     column.integer,
    updated_at:                     column.integer,
  },
